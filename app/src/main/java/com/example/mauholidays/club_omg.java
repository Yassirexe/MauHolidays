...
public class club_omg extends AppCompatActivity {

    DBHelper DB;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.club_omg);
        ...
        boolean isFav = DB.getInfo(username,"omg-3");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"omg-3");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(club_omg.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"omg-3");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(club_omg.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
