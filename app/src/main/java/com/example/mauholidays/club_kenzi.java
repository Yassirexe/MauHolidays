...
public class club_kenzi extends AppCompatActivity {

    DBHelper DB;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.club_kenzi);
        ...
        boolean isFav = DB.getInfo(username,"kenzi_club-3");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"kenzi_club-3");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(club_kenzi.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"kenzi_club-3");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(club_kenzi.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(club_kenzi.this, all_nature.class);
