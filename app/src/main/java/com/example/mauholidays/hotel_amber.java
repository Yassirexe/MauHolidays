...
public class hotel_amber extends AppCompatActivity {

    DBHelper DB;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hotel_amber);
        ...
        boolean isFav = DB.getInfo(username,"amber-4");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"amber-4");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(hotel_amber.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"amber-4");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(hotel_amber.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hotel_amber.this, all_hotel.class);
