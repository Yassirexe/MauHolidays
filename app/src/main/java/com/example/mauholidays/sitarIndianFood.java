...
public class sitarIndianFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sitar_indian_food);
        ...
        boolean isFav = DB.getInfo(username,"sitar-5");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"sitar-5");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(sitarIndianFood.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"sitar-5");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(sitarIndianFood.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sitarIndianFood.this, all_top.class);
