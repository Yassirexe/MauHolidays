...
public class laCroisette extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_la_croisette);
        ...
        boolean isFav = DB.getInfo(username,"la_croisette-5");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"la_croisette-5");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(laCroisette.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"la_croisette-5");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(laCroisette.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(laCroisette.this, all_top.class);
