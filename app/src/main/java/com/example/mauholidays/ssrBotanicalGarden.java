...
public class ssrBotanicalGarden extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssr_botanical_garden);
        ...
        boolean isFav = DB.getInfo(username,"ssr_botanical_garden-4");
        if(isFav) {
        ...
        fav5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fav5.isChecked()) {
                    DB.addToFavourite(username,"ssr_botanical_garden-4");
                    fav5.setButtonDrawable(R.drawable.heart_red);
                    Toast.makeText(ssrBotanicalGarden.this, "Added to favourite", Toast.LENGTH_SHORT).show();
                }else {
                    DB.removeFromFav(username,"ssr_botanical_garden-4");
                    fav5.setButtonDrawable(R.drawable.baseline_favorite_border_24);
                    Toast.makeText(ssrBotanicalGarden.this, "Removed favourite", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ssrBotanicalGarden.this, all_nature.class);
